...
public class ExtMath {
     ...
     * Calculates the Nth percentile of a set of numbers
     */
    public static double percentile(List<Number> values, int percentile) {
        ...
        Arrays.sort(val);
        double percent = ( (double) percentile) / 100;
        double n1 = percent * (val.length - 1) + 1;
        double truncate = (int) n1;
        double frac = n1 - truncate;

        int idx1 = Math.min( (int) truncate - 1, val.length - 1);
        int idx2 = Math.min( (int) truncate, val.length - 1);
        double ak = val[idx1];
        double ak1 = val[idx2];
        return ak + frac * (ak1 - ak);
    }
    ...
    /**
     * Returns whether val is between left and right, exclusively.
     * i.e. left < val < right
     *
     * @param val double
     * @param left double
     ...
     * @return boolean
     */
    public static boolean between(double val, double left, double right) {
        return (left < val && val < right);
    }

    /**
     * Returns whether val is between left and right, inclusively.
     * i.e. left <= val <= right
     *
     * @param val double
     * @param left double
     ...
     * @return boolean
     */
    public static boolean betweenInc(double val, double left, double right) {
        return (left <= val && val <= right);
    }

    /**
     * Returns whether val is between left and right, inclusively left, exclusively right .
     * i.e. left <= val < right
     *
     * @param val double
     * @param left double
     ...
     * @return boolean
     */
    public static boolean betweenLeftInc(double val, double left, double right) {
        return (left <= val && val < right);
    }

    /**
     * Returns whether val is between left and right, exclusively left, inclusively right .
     * i.e. left < val <= right
     *
     * @param val double
     * @param left double
     ...
     * @return boolean
     */
    public static boolean betweenRightInc(double val, double left, double right) {
        return (left <= val && val <= right);
    }
